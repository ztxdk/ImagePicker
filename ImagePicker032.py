...
import numpy as np
import rawpy
from PyQt5.QtCore import QAbstractTableModel, QEvent, QModelIndex, QPoint, QRect, QSize, Qt, QThread, QTimer, QStandardPaths, pyqtSignal
...
APP_VERSION = "0.32"
APP_DISPLAY_NAME = f"{APP_NAME} - v{APP_VERSION} (2026-05-15)"
